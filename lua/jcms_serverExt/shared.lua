...
jcms.cvar_voteEndRoundThreshold = CreateConVar("jcms_voteEndRound_threshold", "0.5", FCVAR_JCMS_SHARED_SAVED, "The ratio of players needed for an end-round vote to be successful. 0.5 means 50% (rounded up).", 0, 1)
